...
class OrderServiceTest {
    ...
    public void 상품주문_재고수량초과() throws Exception {
        ...
        //when
        //then
        assertThrows(NotEnoughStockException.class, () -> orderService.order(member.getId(), item.getId(), orderCount), "재고 수량 예외가 발행해야 한다.");
    }
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("서울", "강남로", "123-123"));
        em.persist(member);
        return member;
    }
}